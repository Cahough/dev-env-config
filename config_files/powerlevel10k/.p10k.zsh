# Generated by Powerlevel10k configuration wizard on 2022-05-05 at 18:29 CDT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 7197.
# Wizard options: compatible, classic, ascii, light, 1 line, compact, concise,
...
() {
  ...
  # *** NOTE ***
  # If working with long dir names, and want stronger truncation prefs, change these settings (match what was used on Bardavon machine)
  # typeset -g POWERLEVEL9K_SHORTEN_FOLDER_MARKER=.shorten_folder_marker
